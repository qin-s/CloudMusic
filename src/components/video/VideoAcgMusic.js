...
class VideoAcgMusic extends React.Component{
    ...
    componentDidMount(){
        this.props.getAcgMusic.call(this)
    }
}
function mapStateToProps(state){
    return {
        videoAcgMusic:state.video.videoAcgMusic
    }
}
    ...
    return {
        getAcgMusic(){
            dispatch(async ()=>{
                ...
                dispatch({
                    type:"UP_ACGMUSIC_LIST",
                    payload:{
                        videoAcgMusic:data.datas
                    }
                })
            })
        }
...
export default connect(mapStateToProps,mapDispatchToProps)(VideoAcgMusic)