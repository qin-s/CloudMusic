...
class VideoDance extends React.Component{
    render(){
        return (
            <div className={"videoEvery"}>
                {
                    this.props.videoDance.map((v,i)=>(
    ...
    componentDidMount() {
        this.props.getDanceList.call(this)
    }
}
function mapStateToProps(state){
    return {
        videoDance:state.video.videoDance
    }
}
...
export default connect(mapStateToProps,mapDispatchToProps)(VideoDance)